    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 via-white to-white text-gray-900">
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="bg-green-100 text-green-600 rounded-full p-2">🌧️</div>
          ...
          {/* Right Image (use next/image, not <img>) */}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="self-start bg-gray-100 text-gray-900 rounded-2xl px-4 py-3 shadow-sm max-w-[75%]">
              <p className="text-base leading-relaxed">Aaj shaam ko barish hogi kya?</p>
          ...
          {/* Right: Text */}
          <div>
            <h2 className="text-4xl font-extrabold text-gray-900 mb-6">Our Solution</h2>
      ...
      <section className="bg-gradient-to-br from-green-50 to-blue-50 py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Innovation Highlights</h2>
      ...
      <section className="px-6 md:px-20 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <Card key={idx} className="p-6 rounded-xl text-center hover:shadow-md transition">
      ...
      <section className="px-6 md:px-20 py-16 bg-gray-50">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[{ name: "Dhruv Dawar" }, { name: "Vidhi Arora" }, { name: "Pari Gupta" }].map(
            (member, idx) => (
              <Card key={idx} className="p-6 rounded-xl text-center hover:shadow-md transition">
